// app/resources/[id]/loading.jsx
// Next.js route-level loading UI — shown automatically while page.js fetches data
  ...
  return (
    <div style={styles.pageWrapper}>
      ...
      <header style={styles.topbar}>
        <div style={{ ...styles.shimmer, width: 72, height: 28, borderRadius: 8 }} />
        <div style={styles.topbarCenter}>
          <div style={{ ...styles.shimmer, width: 90, height: 13, borderRadius: 6 }} />
          <div style={{ ...styles.shimmer, width: 200, height: 16, borderRadius: 6, marginTop: 6 }} />
        </div>
        <div style={styles.topbarActions}>
          {[1, 2, 3].map(i => (
            <div key={i} style={{ ...styles.shimmer, width: 32, height: 32, borderRadius: "50%" }} />
          ))}
        </div>
      </header>
